...
Buildings<-st_read('/Users/u7584446/Library/CloudStorage/OneDrive-AustralianNationalUniversity/Desktop/buildings/Buildings/Buildings.shp')
Buildings<- st_transform(Buildings, st_crs(Proj))

# load landcover raster 
Hab <- raster('/Users/u7584446/Library/CloudStorage/OneDrive-AustralianNationalUniversity/Desktop/buildings/Landcover_10m.tif')
# Define the legend
key <- data.frame(
  feature = c(
    'Tree cover', 
...
slocsb <- read.csv('/Users/u7584446/Library/CloudStorage/OneDrive-AustralianNationalUniversity/Desktop/buildings/Lisa_roost.csv', stringsAsFactors = FALSE)
